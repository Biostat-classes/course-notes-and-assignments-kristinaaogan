...
time spent sleeping? Create a histogram to explore this issue.
...
95% confidence interval for the bar \*
...
Predation risk (as a factor!) – use 1 standard error for the bar. Note
the difference!
...
A 95% confidence interval means that the true population parameter will
be in the interval we created 95% of the time we create it.
...
-   https://www.zoology.ubc.ca/\~whitlock/Kingfisher/CLT.htm
    ...
    If the sample size is large enough, the distribution of the means of
    a data set will have a normal distribution, no matter the
